...
int pop() {
    return savedLineNo[stackSize--];
}
void push(int num) {
    savedLineNo[++stackSize] = num;
}
...
{
       0,    48,    48,    52,    60,    64,    66,    70,    76,    90,
      93,    99,    98,   110,   112,   117,   125,   129,   133,   142,
     145,   148,   151,   154,   162,   172,   175,   185,   188,   190,
     192,   194,   196,   200,   202,   206,   210,   217,   223,   225,
     230,   234,   238,   242,   241,   248,   252,   256,   259,   262,
     265,   268,   271,   276,   280,   284,   287,   292,   296,   300,
     303,   308,   310,   312,   314,   320,   319,   327,   330,   333,
     342
};
#endif
...
{
  "$end", "error", "$undefined", "NOTELSE", "ELSE", "IF", "INT", "RETURN",
  "VOID", "WHILE", "ID", "NUM", "EQ", "NE", "LT", "LE", "GT", "GE", "SEMI",
  "COMMA", "LPAREN", "RPAREN", "LBRACKET", "RBRACKET", "LCURLY", "RCURLY",
  "ASSIGN", "PLUS", "MINUS", "TIMES", "OVER", "ERROR", "$accept",
  "program", "declaration_list", "declaration", "var_declaration",
  "type_specifier", "fun_declaration", "@1", "params", "param_list",
  "param", "id", "num", "lcurly", "rcurly", "compound_stmt",
...
{
      31,   -79,   -79,    19,    31,   -79,   -79,    15,   -79,   -79,
     -79,   -79,    -8,   -79,    -9,    13,   -79,    18,    32,    28,
      37,    15,    42,    55,   -79,   -79,    46,    52,    31,    47,
     -79,   -79,   -79,   -79,   -79,    31,   -79,    15,     2,    -8,
      57,    49,    58,   -79,    51,   -79,    22,   -79,   -79,   -79,
     -79,   -79,   -79,   -79,   -79,    61,    54,   -79,    38,    27,
     -79,   -79,    51,   -79,    63,    51,    62,    53,    64,   -79,
      51,   -79,   -79,   -79,   -79,   -79,   -79,   -79,   -79,    51,
      51,   -79,   -79,    51,    65,   -79,    66,   -79,    51,    51,
     -79,   -79,    45,    27,   -79,    25,    25,    59,   -79,    67,
      70,    81,   -79,   -79,   -79,    51,    25,   -79,   -79
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       3,    19,    11,     7,     0,     0,    20,     0,     0,     0,
      10,     0,     0,    13,    16,     8,    17,     0,     0,     0,
      21,    25,    12,    15,    18,    27,    24,     0,     0,     0,
       0,     0,     0,    34,     0,    22,    42,    64,    23,    29,
      26,    28,    30,    31,    32,     0,    62,    41,    46,    54,
      58,    63,     0,    38,     0,     0,     0,     0,     0,    33,
       0,    51,    52,    49,    50,    48,    47,    55,    56,     0,
...
{
     -79,   -79,   -79,    86,    56,   -12,   -79,   -79,   -79,   -79,
      68,    -6,    78,   -79,   -79,    71,   -79,   -79,   -78,   -79,
     -79,   -79,   -79,   -41,   -75,   -79,   -79,   -79,    14,   -79,
      17,   -79,    11,   -79,   -79,   -79,   -79
};
...
static const yytype_int8 yydefgoto[] =
{
      ...
      24,    46,    47,    31,    48,    49,    35,    38,    50,    51,
      52,    53,    54,    55,    56,    67,    57,    79,    58,    80,
      59,    83,    60,    61,    68,    99,   100
};
...
{
      64,    12,    16,    66,    91,    91,    21,    40,    91,    41,
      13,    42,    11,    16,    14,    26,    21,   101,   102,     9,
      43,    84,    44,    37,    86,    11,    30,    45,   108,    90,
      40,    39,    41,    18,    42,    11,    16,     1,     1,     2,
      20,    19,   -65,    43,   -43,    44,    25,    97,    98,    30,
      71,    72,    73,    74,    75,    76,    81,    82,   -14,    11,
      16,    11,    16,    27,   107,    77,    78,    63,    29,    44,
      34,    44,    77,    78,    28,    88,    30,    62,    65,    69,
      70,    85,   103,    87,    89,   106,    95,    96,   104,   105,
      10,    36,    17,    92,    94,     0,    33,    93,    32
};

static const yytype_int8 yycheck[] =
{
      41,     7,    11,    44,    79,    80,    18,     5,    83,     7,
      18,     9,    10,    11,    22,    21,    28,    95,    96,     0,
      18,    62,    20,    35,    65,    10,    24,    25,   106,    70,
       5,    37,     7,    20,     9,    10,    11,     6,     6,     8,
       8,    23,    20,    18,    22,    20,    18,    88,    89,    24,
      12,    13,    14,    15,    16,    17,    29,    30,    21,    10,
      11,    10,    11,    21,   105,    27,    28,    18,    22,    20,
      23,    20,    27,    28,    19,    22,    24,    20,    20,    18,
      26,    18,    23,    21,    20,     4,    21,    21,    21,    19,
       4,    35,    14,    79,    83,    -1,    28,    80,    27
};
...
static const yytype_uint8 yystos[] =
{
      ...
      35,    10,    43,    18,    22,    39,    11,    44,    20,    23,
       8,    37,    40,    41,    42,    18,    43,    21,    19,    22,
      24,    45,    47,    42,    23,    48,    36,    37,    49,    43,
       5,     7,     9,    18,    20,    25,    43,    44,    46,    47,
      50,    51,    52,    53,    54,    55,    56,    58,    60,    62,
      64,    65,    20,    18,    55,    20,    55,    57,    66,    18,
      26,    12,    13,    14,    15,    16,    17,    27,    28,    59,
      61,    29,    30,    63,    55,    18,    55,    21,    22,    20,
      55,    56,    60,    62,    64,    21,    21,    55,    55,    67,
      68,    50,    50,    23,    21,    19,     4,    55,    50
};
